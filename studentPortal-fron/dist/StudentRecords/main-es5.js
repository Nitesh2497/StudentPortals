...
var AddStudentComponent = /** @class */ (function () {
    function AddStudentComponent(studentService, http, router) {
    ...
    AddStudentComponent.prototype.addStudent = function (student) {
        ...
        var url = 'http://localhost:8080/listStudents/addStudent';
        this.http.post(url, student).subscribe(function (res) {
            if (res === true) {
                console.log('Student Details Added');
                _this.router.navigate(['listStudents']);
            }
            else {
...
var DeleteStudentComponent = /** @class */ (function () {
    function DeleteStudentComponent() {
    }
    DeleteStudentComponent.prototype.ngOnInit = function () {
    };
...
var ListStudentsComponent = /** @class */ (function () {
    function ListStudentsComponent(studService, http, router) {
    ...
    ListStudentsComponent.prototype.fetchStudents = function () {
        var _this = this;
        this.studService.getStudentList().subscribe(function (stud) {
            _this.students = stud;
        });
    };
    ListStudentsComponent.prototype.sendId = function (id) {
        ListStudentsComponent_1.studentId = id;
    };
    ListStudentsComponent.prototype.deleteStudent = function (id) {
        var _this = this;
        this.studService.deleteStudent(id).subscribe(function (stud) {
            if (stud === true) {
    ...
    ListStudentsComponent.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.sendFeedback = function () {
        ...
        this.http.post(url, this.login).subscribe(function (res) {
            if (res != null && res.professor) {
                ...
                _this.router.navigate(['studentHomePage']);
            }
            else {
    ...
    LoginComponent.prototype.toggleVisible = function () {
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (!this.validName || !this.validEmail || !this.validContact || !this.validUserName ||
            ...
            this.http.post(url, this.registerUser).subscribe(function (res) {
                if (res) {
    ...
    RegisterComponent.prototype.validateContact = function () {
...
var ShowStudentDetailComponent = /** @class */ (function () {
    function ShowStudentDetailComponent(http, StudentService, router) {
        this.http = http;
        this.StudentService = StudentService;
        this.router = router;
    }
    ShowStudentDetailComponent.prototype.ngOnInit = function () {
        this.fetchStudent();
    };
    ShowStudentDetailComponent.prototype.fetchStudent = function () {
        var _this = this;
        this.StudentService.getStudent(_list_students_list_students_component__WEBPACK_IMPORTED_MODULE_5__["ListStudentsComponent"].studentId).subscribe(function (res) {
            _this.students = res;
        });
    };
    ShowStudentDetailComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _student_service_service__WEBPACK_IMPORTED_MODULE_3__["StudentServiceService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    ...
    return ShowStudentDetailComponent;
}());
...
var StudentHomePageComponent = /** @class */ (function () {
    function StudentHomePageComponent() {
        // login: Login = {
        //   username: '',
        //   password: '',
        //   name: '',
...
var StudentServiceService = /** @class */ (function () {
    ...
    StudentServiceService.prototype.getStudentList = function () {
        var url = 'http://localhost:8080/listStudents';
        return this.http.get(url);
    };
    StudentServiceService.prototype.getStudent = function (id) {
        var url = 'http://localhost:8080/listStudents/showStudentDetails/' + id;
        return this.http.get(url);
    };
    StudentServiceService.prototype.addStudent = function (student) {
        var url = 'http://localhost:8080/listStudents/addStudent';
        return this.http.post(url, student);
    };
    StudentServiceService.prototype.deleteStudent = function (id) {
        var url = 'http://localhost:8080/listStudents/deleteStudent/' + id;
        return this.http.get(url);
    };
    StudentServiceService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var UpdateStudentComponent = /** @class */ (function () {
    function UpdateStudentComponent(http, studentService, router) {
        this.http = http;
        this.studentService = studentService;
        this.router = router;
        this.student = new _app_module__WEBPACK_IMPORTED_MODULE_2__["Studentdetails"]();
    ...
    UpdateStudentComponent.prototype.fetchStudents = function () {
        var _this = this;
        this.studentService.getStudent(_list_students_list_students_component__WEBPACK_IMPORTED_MODULE_6__["ListStudentsComponent"].studentId).subscribe(function (res) {
            _this.student = res;
            console.log('Got Student Details back');
        });
    };
    UpdateStudentComponent.prototype.updateStudent = function (student) {
        var _this = this;
    ...
    UpdateStudentComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
